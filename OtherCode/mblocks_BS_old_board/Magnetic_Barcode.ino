...
//          }
      ...
      else if(magnetic_neighbors[face] > 1 && (face == 1 || face == 2 || face == 4) && angle2 > 72 && angle2 < 108 && angle1 > 162 && angle1 < 198)   {Serial.println("ia r 6000 2800 15 e 10");delay(1500);Serial.println("stillalive");delay(1300);Serial.println("stillalive");}//cmd = "forward_traverse";} 
      else if(magnetic_neighbors[face] > 1 && face == 3 && angle1 < 108 && angle1 > 72 && (angle2 > 343 || angle2 < 12))                              {Serial.println("ia r 6000 2800 15 e 10");delay(1500);Serial.println("stillalive");delay(1300);Serial.println("stillalive");}

      else if(magnetic_neighbors[face] > 1 && (face == 1 || face == 2 || face == 4) && angle1 > 72 && angle1 < 108 && angle2 > 162 && angle2 < 198)   {Serial.println("ia f 6000 2500 15 e 10");delay(1500);Serial.println("stillalive");delay(1300);Serial.println("stillalive");}//cmd = "forward_traverse";} 
      else if(magnetic_neighbors[face] > 1 && face == 3 && angle2 < 108 && angle2 > 72 && (angle1 > 343 || angle1 < 12))                              {Serial.println("ia f 6000 2500 15 e 10");delay(1500);Serial.println("stillalive");delay(1300);Serial.println("stillalive");}
