...
void process_5048(int face)
{
   ...
   check_5048b(face);// angle1 angle2 mag1 mag2 signed_angle1...2... are now updated for face [face]
      ...
      else if(magnetic_neighbors[face] > 1 && angle1 > 250 && angle1 < 270 && angle2 > 80 && angle2 < 100)  {light_up_purple(face);} // Purple
      else if(magnetic_neighbors[face] > 1 && angle2 > 250 && angle2 < 270 && angle1 > 80 && angle1 < 100)  {light_up_purple(face);}
      else if(magnetic_neighbors[face] > 1 && angle1 > 330 && angle1 < 350 && angle2 > 170 && angle2 < 190) {light_up_purple(face);}
      else if(magnetic_neighbors[face] > 1 && angle2 > 330 && angle2 < 350 && angle1 > 170 && angle1 < 190) {light_up_purple(face);}
