...
void setup() 
{
   ...
   // write_expander_low(expander_address);
...
//Serial.print("Reading ACCELEROMETER ");Serial.println();
//read_gyro_and_accel(0x69);
blink_and_shout();
...
void shift_and_update_IMU()
{
  ...
  if(motion_sum_log[0] > 10000 && motion_sum_log[1] > 10000 && motion_sum_log[2] > 10000)
  {
    ...
    all_faces_everything_off();
    delay(250);
    if(read_gyro_and_accel(0x69) > 5000) {blink_blue_twice_fast();Serial.println("stillalive");delay(1000);Serial.println("stillalive");delay(1000);Serial.println("stillalive"); blink_blue_twice_fast(); delay(1000); for(int i = 0; i < 3; i++){Serial.println("sleep");delay(200);}}
  }
}
        ...
        if((mag1 > 0 && mag1 < 254) || (mag2 > 0 && mag2 < 254))
          {
            ...
            Serial.print("mag_digit_1: "); Serial.print(mag_digit_1); Serial.print("    ");  Serial.print("ANGLE1: "); Serial.print(angle1);  Serial.print("    ");  Serial.print("MAGNITUDE1: "); Serial.println(mag1); 
            Serial.print("mag_digit_2: "); Serial.print(mag_digit_2); Serial.print("    ");  Serial.print("ANGLE2: "); Serial.print(angle2);  Serial.print("    ");  Serial.print("MAGNITUDE1: "); Serial.println(mag2);    
          }
          
           if(magnetic_neighbors_most_recent[face] > 1 && magnetic_neighbors[face] == 0)                    {turn_off_face(face);} // turns off LED's if no longer connected
      else if(magnetic_neighbors[face] > 1 && (face == 1 || face == 2 || face == 4) && angle1 > 72 && angle1 < 108 && angle2 > 162 && angle2 < 198)   {Serial.println("ia f 6000 3000 15 e 10");delay(1500);Serial.println("stillalive");delay(1300);Serial.println("stillalive");}//cmd = "forward_traverse";} 
      else if(magnetic_neighbors[face] > 1 && face == 3 && angle2 < 108 && angle2 > 72 && (angle1 > 343 || angle1 < 12))                              {Serial.println("ia f 6000 3000 15 e 10");delay(1500);Serial.println("stillalive");delay(1300);Serial.println("stillalive");}

      else if(magnetic_neighbors[face] > 1 && (face == 1 || face == 2 || face == 4) && angle2 > 72 && angle2 < 108 && angle1 > 162 && angle1 < 198)   {Serial.println("ia r 6000 2500 15 e 10");delay(1500);Serial.println("stillalive");delay(1300);Serial.println("stillalive");}//cmd = "forward_traverse";} 
      else if(magnetic_neighbors[face] > 1 && face == 3 && angle1 < 108 && angle1 > 72 && (angle2 > 343 || angle2 < 12))                              {Serial.println("ia r 6000 2500 15 e 10");delay(1500);Serial.println("stillalive");delay(1300);Serial.println("stillalive");}
